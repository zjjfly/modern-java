(defproject com.github.zjjfly/sequences "0.1"
  ...
  :resource-paths ["src/main/resources/main"]
  ...
  :profiles {:server {:main jjzi.sequences.App
                      ...
                      :resource-paths ["src/main/resources/server"]}
             :client {:main liu.mars.Client
                      :jvm-opts ["-Dconfig.resource=client.conf"]
                      :resource-paths ["src/main/resources/client"]}
             :test {:jvm-opts ["-Dconfig.resource=junit.conf"]
                    :resource-paths ["src/main/resources/test"]}})
